...
'The Core': 'The Core',
'The Image must be smaller than 200KB': 'The Image must be smaller than 200KB',
...
'Working...': 'Working...',
'You already submitted a file by that name': 'You already submitted a file by that name',
