...
'%(first_name)s %(last_name)s': '%(first_name)s %(last_name)s',
'%(name)s': '%(name)s',
'%(tbl)s': '%(tbl)s',
'%(tbl)s Reviews': '%(tbl)s Opiniones',
'%(tbl)ss': '%(tbl)ss',
'%(title)s: %(subject)s': '%(title)s: %(subject)s',
'%Y-%m-%d': '%Y-%m-%d',
...
'Cost': 'Precios',
'Country': 'Pais',
'Create %(tbl)s Profile': 'Nuevo %(tbl)s Perfile',
'Create %(tbl)s Review': 'Nuevo %(tbl)s Opinión',
...
'Manage': 'Administrar',
'Manage Contributors': 'Administrar Contribuyentes',
...
'Please Log On To Comment': 'Por favor inico de sesión para comentar',
'Post Profile': 'Nuevo Perfile',
'Post Review': 'Nuevo Opinión',
'Powered by': 'Este sitio usa',
'Profiles': 'Perfiles',
'Query:': 'Consulta:',
'Quick Search': 'Quick Search',
'Quick Search Profiles': 'Quick Search Profiles',
'Quick Search Reviews': 'Quick Search Reviews',
'Recent': 'Nuevo',
'Record ID': 'ID de Registro',
'Records Found': 'Resultado Encontado',
'Region': 'Region',
'Register': 'Registrese',
